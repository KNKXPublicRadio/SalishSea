...
PROJECT_SLUG = 'SalishSea'

# Project name to be used in file paths
PROJECT_FILENAME = 'SalishSea'

# The name of the repository containing the source
REPOSITORY_NAME = 'SalishSea'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1MozzuXl7kTNkGahpH4HBJTxjcJ1rnt6qNl5KTSIsBQY'
