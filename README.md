...
```
* * * * * ubuntu bash /home/ubuntu/apps/SalishSea/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|SalishSea|tweet|`location`||
|SalishSea|facebook|`location`||
|SalishSea|email|`location`||
|SalishSea|new-comment||
|SalishSea|open-share-discuss||
|SalishSea|close-share-discuss||
|SalishSea|summary-copied||
|SalishSea|featured-tweet-action|`action`|
|SalishSea|featured-facebook-action|`action`|
